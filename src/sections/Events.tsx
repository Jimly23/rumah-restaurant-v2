...
const Events = () => {
  ...
  return (
    <section className="section-bg py-24 px-4 font-sans overflow-hidden" id="events">
      {/* Header */}
        ...
        {events.map((event, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Content Wrapper */}
              <div
                className={`w-full md:w-1/2 pl-16 md:pl-0 ${isLeft ? 'md:pl-12 text-left' : 'md:pr-12 md:text-right'
                  }`}
              >
                <div
                ...
                >
                  {/* Triangle Arrow */}
                  <div className={`absolute top-4 w-0 h-0 border-y-[10px] border-y-transparent hidden md:block ${isLeft
