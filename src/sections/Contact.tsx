                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      {item.phones.map((phone, idx) => (
                        <React.Fragment key={phone.link}>
                          <a
                            href={phone.link}
                            className="cursor-pointer text-[#1c5302] text-base md:text-2xl font-light leading-relaxed hover:text-white"
                          >
                            {phone.content}
                          </a>
              ...
              return (
                <div key={item.id} className="flex items-center gap-5 group">
                  ...
                  <a
                    ...
                    className="cursor-pointer text-[#1c5302] lowercase md:text-2xl font-light leading-relaxed hover:text-white"
                  >
                    {item.content}
                  </a>
                </div>
